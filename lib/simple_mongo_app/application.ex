defmodule SimpleMongoApp.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(SimpleMongoApp.Repo, []),
      # Start the endpoint when the application starts
      supervisor(SimpleMongoAppWeb.Endpoint, []),
      # Start your own worker by calling: SimpleMongoApp.Worker.start_link(arg1, arg2, arg3)
      # worker(SimpleMongoApp.Worker, [arg1, arg2, arg3]),
    ]
